...
@section('title', 'Edit Role - ' . $authorization->role)
...
@section('content')
    <div class="d-flex justify-content-center mt-5">
        <form action="{{ route('dashboard.authorizations.update', $authorization->id) }}" method="POST"
            class="card shadow-lg p-4" style="max-width: 800px; width: 100%; border-radius: 10px;">
            @csrf
            @method('PUT')
            <div class="card-body">
                <!-- Header Section -->
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="text-primary mb-0">Edit Role - {{ $authorization->role }}</h2>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="role" name="role" value="{{ old('role', $authorization->role) }}"
                            ...
                            <div class="col-md-4 col-sm-6 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input permession-checkbox" type="checkbox" name="permessions[]"
                                        ...
                                        {{ in_array($key, old('permessions', $authorization->permessions)) ? 'checked' : '' }}>
