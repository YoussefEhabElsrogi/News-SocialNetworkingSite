...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <p class="mb-4">You can manage your posts from this page. If you want to add a new post, click <a
                href="{{ route('dashboard.posts.create') }}">here</a>.</p>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            @forelse ($posts as $post)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('dashboard.posts.changeStatus', $post->id) }}"><i
                                        ...
                                        @if ($post->user_id == null)
                                            <a href="{{ route('dashboard.posts.edit', $post->id) }}"><i
                            ...
                            @empty
                                <tr>
                                    <div class="alert alert-info" colspan="6"> No posts</d>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
