        ...
        <form action="{{ route('dashboard.users.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body shadow mb-4 col-10">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <input type="text" name="phone" value="{{ old('phone') }}" placeholder="Enter User Phone"
                                class="form-control">
                            @error('phone')
                                <strong class="text-danger">{{ $message }}</strong>
                            @enderror
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <select name="email_verified_at" class="form-control">
                                ...
                                <option value="1" {{ old('email_verified_at') == '1' ? 'selected' : '' }}>Active
                                </option>
                                <option value="0" {{ old('email_verified_at') == '0' ? 'selected' : '' }}>Not Active
                                </option>
                            </select>
