...
return [
    ...
    */
    ...
    | You may configure multiple sources for different user tables or models.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Configure password reset settings for different user types.
    | Includes the provider, reset table, expiration time, and throttling.
    |
    */
